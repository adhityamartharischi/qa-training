...
WebUI.selectOptionByValue(findTestObject('Page_CURA Healthcare Service/div_Medicare                          Medicaid                                None'), 
    healthcare_program, false)

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_CURA Healthcare Service/input_Visit Date (Required)_visit_date'), 
    visit_date, false)

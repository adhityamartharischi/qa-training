...
WebUI.click(findTestObject('Page_CURA Healthcare Service/td_31'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Page_CURA Healthcare Service/textarea_Comment_comment'), 'Real Test Case')

WebUI.click(findTestObject('Page_CURA Healthcare Service/button_Book Appointment'), FailureHandling.STOP_ON_FAILURE)
